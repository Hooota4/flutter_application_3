...
class _$_ImageModel implements _ImageModel {
  const _$_ImageModel({required this.url, required this.type});
  ...
  @override
  String toString() {
    return 'ImageModel(url: $url, type: $type)';
  }
...
abstract class _ImageModel implements ImageModel {
  const factory _ImageModel(
      {required final String url, required final String type}) = _$_ImageModel;
